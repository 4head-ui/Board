...
from .views import index,other_page,BBLoginView,profile,\
    BBLogoutView,ChangeUserInfoView,BBPasswordChangeView,RegisterUserView,\
    RegisterDoneView,user_activate,DeleteUserView,by_rubric,detail,\
...
urlpatterns = [
    ...
    path('accounts/profile/<int:rubric_pk>/<int:pk>/', profile_bb_detail, name='profile_bb_detail'),
